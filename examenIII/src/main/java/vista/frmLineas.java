...
public class frmLineas extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeCombos() {
        daoLineas LineaDAO = new daoLineas();
        List<clsLineas> aplicaciones = LineaDAO.select();
        cbox_aplicacion.addItem("Seleccione una opción");
        for (int i = 0; i < aplicaciones.size(); i++) {
            cbox_aplicacion.addItem(aplicaciones.get(i).getNombre_linea());
        }
    }
    ...
    public void llenadoDeTablas() {
        ...
        daoLineas aplicacionDAO = new daoLineas();
        List<clsLineas> aplicaciones = aplicacionDAO.select();
        tablaAplicaciones.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < aplicaciones.size(); i++) {
            dato[0] = Integer.toString(aplicaciones.get(i).getCodigo_linea());
            dato[1] = aplicaciones.get(i).getNombre_linea();
            dato[2] = aplicaciones.get(i).getEstatus_linea();
    ...
    public void buscaraplicacion() {
        clsLineas lineaAConsultar = new clsLineas();
        daoLineas LineaDAO = new daoLineas();
        lineaAConsultar.setCodigo_linea(Integer.parseInt(txtbuscado.getText()));
        lineaAConsultar = LineaDAO.query(lineaAConsultar);
        txtcodigo.setText(String.valueOf(lineaAConsultar.getCodigo_linea()));
        txtnombre.setText(lineaAConsultar.getNombre_linea());
        txtestatus.setText(lineaAConsultar.getEstatus_linea());
    }
    ...
    private void initComponents() {
        ...
        tablaAplicaciones.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo Linea", "Nombre Linea", "Estatus Linea"
            }
        ) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        daoLineas aplicacionDAO = new daoLineas();
        clsLineas aplicacionAEliminar = new clsLineas();
        aplicacionAEliminar.setCodigo_linea(Integer.parseInt(txtbuscado.getText()));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        daoLineas aplicacionDAO = new daoLineas();
        clsLineas lineaAInsertar = new clsLineas();
        lineaAInsertar.setCodigo_linea(    Integer.parseInt(txtcodigo.getText()));
        lineaAInsertar.setNombre_linea(txtnombre.getText());
        lineaAInsertar.setEstatus_linea(txtestatus.getText());
        aplicacionDAO.insert(lineaAInsertar);
        llenadoDeTablas();
...
//        // TODO add your handling code here:
        daoLineas aplicacionDAO = new daoLineas();
        clsLineas aplicacionAActualizar = new clsLineas();
        aplicacionAActualizar.setCodigo_linea(Integer.parseInt(txtbuscado.getText()));
        aplicacionAActualizar.setNombre_linea(txtcodigo.getText());
        aplicacionAActualizar.setEstatus_linea(txtnombre.getText());
