...
public class daoUsuarios {
    ...
    private static final String SQL_SELECT = "SELECT id_usuario, nombre, correo, contraseña, cargo FROM usuario";
    private static final String SQL_INSERT = "INSERT INTO usuario(nombre,correo,contraseña,cargo) VALUES(?, ?, ?, ?)";
    private static final String SQL_UPDATE = "UPDATE usuario SET Nombre=?, Correo=?, Contraseña=?, AND cargo=? WHERE id_usuario = ?";
    private static final String SQL_DELETE = "DELETE FROM usuario WHERE id_usuario=?";
    private static final String SQL_QUERY = "SELECT id_usuario, nombre, correo, contraseña, cargo FROM usuario WHERE nombre = ?";
